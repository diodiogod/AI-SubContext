#!/usr/bin/env python3
"""Bump the AI SubContext version, update changelog, and optionally commit."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Bump AI SubContext version with separate commit and changelog descriptions."
    )
    parser.add_argument(
        "version",
    ...
    if not current_version:
        print("Error: Could not determine the current AI SubContext version")
        return 1
    ...
    try:
        ...
        print(f"Successfully bumped AI SubContext to v{new_version}")
        return 0
