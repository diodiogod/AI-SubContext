#!/usr/bin/env python3
"""Version management helpers for AI SubContext."""
...
class VersionManager:
    ...
    def get_current_version(self) -> Optional[str]:
        version_file = os.path.join(self.project_root, "app", "version.py")
        try:
        ...
        match = re.search(
            self.version_files["app/version.py"]["replacements"][0]["pattern"],
            content,
        )
