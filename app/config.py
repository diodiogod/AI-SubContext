...
class TranslationSettings(BaseModel):
    ...
    visual_scene_context: bool = Field(default=False)
    visual_scene_frames: int = Field(default=4, ge=2, le=6)
    visual_scene_frame_max_side: int = Field(default=640, ge=320, le=1024)
    adaptive_vision: bool = Field(default=False)
    vision_max_doubts: int = Field(default=1, ge=1, le=3)
    vision_max_frames: int = Field(default=4, ge=2, le=6)
    vision_frame_max_side: int = Field(default=448, ge=256, le=768)
